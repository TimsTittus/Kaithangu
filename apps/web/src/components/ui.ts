...
export const iconButtonClass = `inline-flex size-12 shrink-0 items-center justify-center rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm hover:bg-neutral-50 dark:hover:bg-neutral-700 active:scale-95 transition-all ${focus}`;
...
export const choiceSelectedClass = 'border-emerald-600 bg-emerald-50/80 dark:bg-emerald-950/50 shadow-sm';

export const choiceIdleClass = 'border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800/60 hover:border-emerald-300';
