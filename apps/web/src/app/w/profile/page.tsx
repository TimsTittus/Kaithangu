  ...
  return (
    <main className={pageClass}>
      ...
      <section className="flex flex-col gap-2">
        <span className="text-sm font-bold text-neutral-800">Registered Trades & Certifications</span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-neutral-500">Government Certified · Master Grade</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-neutral-500">A/C: •••• 4921 · Mattancherry Service Co-op</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-neutral-500">Toll-free 1800-425-COOP (08:00 - 20:00)</span>
              </div>
            </div>
            <ChevronRight className="size-5 text-neutral-400" />
          </div>
