...
export default async function AdminProfilePage() {
  ...
  const name = session?.user.name ?? 'LCS Administrator (Demo)';
    ...
    <main className={pageClass}>
      ...
      <div className="flex flex-col items-center rounded-3xl border border-emerald-950/10 bg-white p-6 text-center shadow-xs">
        ...
        <span className="mt-0.5 text-xs font-semibold text-emerald-700">
          Labour Cooperative Society Admin (LCS)
        </span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-neutral-900">Kerala Labour Co-op Federation</span>
          ...
          <div className="flex items-center justify-between border-t border-neutral-100 pt-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-neutral-500">National Council for Cooperative Training</span>
              </div>
            </div>
            <span className="rounded-full bg-emerald-100 px-2.5 py-0.5 text-[11px] font-bold text-emerald-800">
              Verified
      ...
      <section className="flex flex-col gap-2">
        <span className="text-sm font-bold text-neutral-800">Administration & Governance</span>
        <div className="flex flex-col overflow-hidden rounded-3xl border border-neutral-200 bg-white shadow-xs divide-y divide-neutral-100">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-neutral-900">State Trade Rates (KLD-2026)</span>
                <span className="text-xs text-neutral-500">Wage Floor & Emergency Surcharge Rules</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-neutral-900">Worker Roster & Verification</span>
                <span className="text-xs text-neutral-500">100 active · Ernakulam Jurisdiction</span>
              </div>
            </div>
            <ChevronRight className="size-5 text-neutral-400" />
          </div>

          <Link href="/language" className="flex items-center justify-between p-4 hover:bg-neutral-50">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-800">
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-neutral-900">Federation Admin Support</span>
                <span className="text-xs text-neutral-500">Desk: 0484-2391000 · admin@kaithangu.coop</span>
              </div>
            </div>
            <ChevronRight className="size-5 text-neutral-400" />
          </div>
